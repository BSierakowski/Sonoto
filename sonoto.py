...
class TweetRc(object):
    ...
    def _GetOption(self, option):
        try:
            return self._GetOption().get('Tweet', option)
        except:
            return None
...
def main():
    try:
        ...
        PrintUsageAndExit()
    consumer_keyflag = '93arJcXGK5mS7Z9DmDGsw'
    consumer_secretflag = 'UE05zfozHMXDPGf31cuGP1AXzeZgTlYi3625ORvI'
    access_keyflag = '319657785-TnGtUO5oJdr2p0eY8AiX7kCcuBF3oAIHMR1GqPu7'
    access_secretflag = 'aQ9mcNS6Y8s1xzwtNqlT554znpqIXGtzeeuYkjQ4s8'
    encoding = None
    for o, a in opts:
        if o in ("-h", "--help"):
            PrintUsageAndExit()
